    ...
    return (
        <div className="bg-transparent p-8 rounded-lg shadow-lg text-center text-white">
          ...
          dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-700">
                                ...
                                {dateConfirmation && (
                                    <a disabled={dateConfirmation ? true : false} href="./svday.pdf" download class={`mt-5 text-white ${!dateConfirmation ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300'} font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`}>
                                        {btnClickMessage}
                                    </a>
                                )}
                            </div>
